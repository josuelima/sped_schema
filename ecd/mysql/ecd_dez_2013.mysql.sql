...
CREATE TABLE `reg_0000` (
  ...
  `LECD` varchar(4) collate {COLLATE} default NULL,
  ...
  `IE` varchar(255) collate {COLLATE} default NULL,
  ...
  `IND_NIRE` varchar(1) collate {COLLATE} default NULL,
  `IND_FIN_ESC` varchar(1) collate {COLLATE} default NULL,
  `COD_HASH_SUB` varchar(40) collate {COLLATE} default NULL,
  `NIRE_SUBST` varchar(11) collate {COLLATE} default NULL,
  `IND_GRANDE_PORTE` varchar(1) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
...
CREATE TABLE `reg_0007` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_ENT_REF` varchar(255) collate {COLLATE} default NULL,
  `COD_INSCR` varchar(255) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_0150` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_PART` varchar(255) collate {COLLATE} default NULL,
  `NOME` varchar(255) collate {COLLATE} default NULL,
  `COD_PAIS` varchar(5) collate {COLLATE} default NULL,
  `CNPJ` varchar(14) collate {COLLATE} default NULL,
  `CPF` varchar(11) collate {COLLATE} default NULL,
  `NIT` varchar(11) collate {COLLATE} default NULL,
  `UF` varchar(2) collate {COLLATE} default NULL,
  `IE` varchar(255) collate {COLLATE} default NULL,
  `IE_ST` varchar(255) collate {COLLATE} default NULL,
  `COD_MUN` varchar(7) collate {COLLATE} default NULL,
  `IM` varchar(255) collate {COLLATE} default NULL,
...
CREATE TABLE `reg_0180` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_REL` varchar(2) collate {COLLATE} default NULL,
...
CREATE TABLE `reg_i012` (
  ...
  `NAT_LIVRO` varchar(80) collate {COLLATE} default NULL,
  `TIPO` varchar(1) collate {COLLATE} default NULL,
  `COD_HASH_AUX` varchar(40) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i015` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_CTA_RES` varchar(255) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i020` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `REG_COD` varchar(4) collate {COLLATE} default NULL,
  `NUM_AD` varchar(255) collate {COLLATE} default NULL,
  `CAMPO` varchar(255) collate {COLLATE} default NULL,
  `DESCRICAO` varchar(255) collate {COLLATE} default NULL,
  `TIPO` varchar(255) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i030` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `DNRC_ABERT` varchar(17) collate {COLLATE} default NULL,
  `NUM_ORD` varchar(18) collate {COLLATE} default NULL,
  ...
  `DESC_MUN` varchar(255) collate {COLLATE} default NULL,
  `DT_EX_SOCIAL` date default NULL,
  `NOME_AUDITOR` varchar(255) collate {COLLATE} default NULL,
  `COD_CVM_AUDITOR` varchar(255) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i051` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_ENT_REF` varchar(2) collate {COLLATE} default NULL,
...
CREATE TABLE `reg_i052` (
  ...
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_CCUS` varchar(255) collate {COLLATE} default NULL,
  `COD_AGL` varchar(255) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i075` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_HIST` varchar(255) collate {COLLATE} default NULL,
  `DESCR_HIST` varchar(255) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i151` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `ASSIN_DIG` mediumtext collate {COLLATE},
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i200` (
  ...
  `IND_LCTO` varchar(1) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i250` (
  ...
  `IND_DC` varchar(1) collate {COLLATE} default NULL,
  `NUM_ARQ` varchar(255) collate {COLLATE} default NULL,
  `COD_HIST_PAD` varchar(255) collate {COLLATE} default NULL,
  `HIST` mediumtext collate {COLLATE},
  `COD_PART` varchar(255) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i500` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `TAM_FONTE` varchar(2) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_i510` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `NM_CAMPO` varchar(16) collate {COLLATE} default NULL,
  `DESC_CAMPO` varchar(50) collate {COLLATE} default NULL,
  `TIPO_CAMPO` varchar(1) collate {COLLATE} default NULL,
  `TAM_CAMPO` varchar(3) collate {COLLATE} default NULL,
  `DEC_CAMPO` varchar(2) collate {COLLATE} default NULL,
  `COL_CAMPO` varchar(3) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_j005` (
  ...
  `DT_INI` date default NULL,
  `DT_FIN` date default NULL,
  `ID_DEM` varchar(1) collate {COLLATE} default NULL,
  `CAB_DEM` mediumtext collate {COLLATE},
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_j100` (
  ...
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_AGL` varchar(255) collate {COLLATE} default NULL,
  `NIVEL_AGL` varchar(255) collate {COLLATE} default NULL,
  `IND_GRP_BAL` varchar(1) collate {COLLATE} default NULL,
  `DESCR_COD_AGL` varchar(255) collate {COLLATE} default NULL,
  `VL_CTA` decimal(21,2) default NULL,
  `IND_DC_BAL` varchar(1) collate {COLLATE} default NULL,
  `VL_CTA_INI` decimal(21,2) default NULL,
  `IND_DC_BAL_INI` varchar(1) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_j150` (
  ...
  `DESCR_COD_AGL` varchar(255) collate {COLLATE} default NULL,
  `VL_CTA` decimal(21,2) default NULL,
  `IND_VL` varchar(1) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_j200` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `COD_HIST_FAT` varchar(255) collate {COLLATE} default NULL,
  `DESC_FAT` varchar(255) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_j210` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `IND_TIP` varchar(1) collate {COLLATE} default NULL,
  `COD_AGL` varchar(255) collate {COLLATE} default NULL,
  `DESCR_COD_AGL` varchar(255) collate {COLLATE} default NULL,
  `VL_CTA` decimal(21,2) default NULL,
  `IND_DC_CTA` varchar(1) collate {COLLATE} default NULL,
  `VL_CTA_INI` decimal(21,2) default NULL,
  `IND_DC_CTA_INI` varchar(1) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_j215` (
  ...
  `IND_DC_FAT` varchar(1) collate {COLLATE} default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE={ENGINE} DEFAULT CHARSET={CHARSET} COLLATE={COLLATE};
...
CREATE TABLE `reg_j900` (
  `ID` bigint(20) NOT NULL,
  `REG` varchar(4) collate {COLLATE} default NULL,
  `DNRC_ENCER` varchar(21) collate {COLLATE} default NULL,
  `NUM_ORD` varchar(255) collate {COLLATE} default NULL,
  `NAT_LIVRO` varchar(80) collate {COLLATE} default NULL,
  `NOME` varchar(255) collate {COLLATE} default NULL,
  `QTD_LIN` varchar(255) collate {COLLATE} default NULL,
...
CREATE TABLE `reg_j930` (
  ...
  `IDENT_CPF` varchar(11) collate {COLLATE} default NULL,
  `IDENT_QUALIF` varchar(255) collate {COLLATE} default NULL,
  `COD_ASSIN` varchar(3) collate {COLLATE} default NULL,
  ...
  `UF_CRC` varchar(2) collate {COLLATE} default NULL,
  `NUM_SEQ_CRC` varchar(255) collate {COLLATE} default NULL,

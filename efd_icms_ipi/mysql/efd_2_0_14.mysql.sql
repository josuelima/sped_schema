...
CREATE TABLE `reg_C100` (
  ...
  `arquivo_id` bigint(20) default NULL,
  `empresa_id` bigint(20) default NULL,
  `codigo` varchar(14) collate latin1_general_ci default NULL,
  `NOME_PARTICIPANTE` varchar(100) collate latin1_general_ci default NULL,
  `HASH_PARTICIPANTE` char(36) default NULL,
  PRIMARY KEY (`ID`),
  KEY `idx_hash` (`HASH`),
  KEY `idx_hash_pai` (`HASH_PAI`),
  KEY `idx_hash_master` (`HASH_MASTER`),
...
CREATE TABLE `reg_C170` (
  ...
  `HASH_PARTICIPANTE` char(36) default NULL,
  `DESCR_ITEM` varchar(255) collate latin1_general_ci default NULL,
  `HASH_ITEM` char(36) default NULL,
  PRIMARY KEY (`ID`),
  KEY `idx_hash` (`HASH`),
  KEY `idx_hash_pai` (`HASH_PAI`),
  KEY `idx_hash_master` (`HASH_MASTER`),
